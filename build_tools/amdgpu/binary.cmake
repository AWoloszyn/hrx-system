...
function(_iree_amdgpu_add_generated_input_dependencies TARGET_NAME)
  ...
  get_target_property(_OBJECT_TARGET "${TARGET_NAME}" IREE_CC_OBJECT_TARGET)
  if(_OBJECT_TARGET AND NOT _OBJECT_TARGET STREQUAL "${TARGET_NAME}")
    list(APPEND _CONSUMER_TARGETS "${_OBJECT_TARGET}")
  endif()
