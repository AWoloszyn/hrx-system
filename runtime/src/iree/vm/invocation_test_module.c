...
static const iree_vm_module_callable_type_declaration_t
    iree_vm_test_callable_types[] = {
        ...
        {{{iree_vm_test_add_arguments,
           IREE_ARRAYSIZE(iree_vm_test_add_arguments), 2, 0, 0},
          {iree_vm_test_i32, IREE_ARRAYSIZE(iree_vm_test_i32), 1, 0, 0}},
         IREE_VM_CALLABLE_TYPE_FLAG_NONE,
         0,
         0},
        {{{iree_vm_test_launch_config_arguments,
           IREE_ARRAYSIZE(iree_vm_test_launch_config_arguments), 2, 0, 0},
          {iree_vm_test_launch_config_results,
           IREE_ARRAYSIZE(iree_vm_test_launch_config_results), 11, 0, 0}},
         IREE_VM_CALLABLE_TYPE_FLAG_NONE,
         0,
         0},
        {{{iree_vm_test_f32_arguments,
           IREE_ARRAYSIZE(iree_vm_test_f32_arguments), 2, 0, 0},
          {iree_vm_test_f32_result, IREE_ARRAYSIZE(iree_vm_test_f32_result), 1,
           0, 0}},
         IREE_VM_CALLABLE_TYPE_FLAG_NONE,
         0,
         0},
        {{{NULL, 0, 0, 0, 0},
          {iree_vm_test_function_result,
           IREE_ARRAYSIZE(iree_vm_test_function_result), 0, 0, 1}},
         IREE_VM_CALLABLE_TYPE_FLAG_NONE,
         1,
         0},
        {{{iree_vm_test_call_function_arguments,
           IREE_ARRAYSIZE(iree_vm_test_call_function_arguments), 2, 0, 1},
          {iree_vm_test_i32, IREE_ARRAYSIZE(iree_vm_test_i32), 1, 0, 0}},
         IREE_VM_CALLABLE_TYPE_FLAG_NONE,
         1,
         0},
