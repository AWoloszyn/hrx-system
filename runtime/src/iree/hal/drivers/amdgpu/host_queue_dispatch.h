...
// Validates an AMDGPU cooperative queue_dispatch request without requiring
// transient bindings to have committed backing storage yet.
iree_status_t
...
// Emits a cooperative executable kernel dispatch. Caller must hold
// submission_mutex.
