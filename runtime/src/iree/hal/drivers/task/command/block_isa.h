...
#ifndef IREE_HAL_DRIVERS_TASK_COMMAND_BLOCK_ISA_H_
#define IREE_HAL_DRIVERS_TASK_COMMAND_BLOCK_ISA_H_
...
typedef struct iree_hal_task_executable_t iree_hal_task_executable_t;
...
#endif  // IREE_HAL_DRIVERS_TASK_COMMAND_BLOCK_ISA_H_
