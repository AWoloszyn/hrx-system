...
static iree_status_t iree_hal_replay_dump_append_text_atomic_store_params(
  ...
  return iree_string_builder_append_format(
      builder,
      " value=0x%016" PRIx64 " flags=0x%08" PRIx32 " width=%" PRIu8
