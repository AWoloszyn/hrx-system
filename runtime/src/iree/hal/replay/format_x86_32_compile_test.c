...
static_assert(iree_alignof(iree_hal_atomic_wait_params_t) ==
                  iree_alignof(uint64_t),
              "atomic wait parameters must retain natural uint64_t alignment");
static_assert(iree_alignof(iree_hal_atomic_store_params_t) ==
                  iree_alignof(uint64_t),
              "atomic store parameters must retain natural uint64_t alignment");
static_assert(iree_alignof(iree_hal_atomic_rmw_params_t) ==
                  iree_alignof(uint64_t),
...
static_assert(offsetof(iree_hal_replay_atomic_rmw_params_payload_t,
              ...
              "atomic RMW target error mode offset must remain stable");
static_assert(iree_alignof(iree_hal_replay_atomic_wait_params_payload_t) ==
                  iree_alignof(uint64_t),
              "atomic wait payload must retain natural uint64_t alignment");
static_assert(iree_alignof(iree_hal_replay_atomic_store_params_payload_t) ==
                  iree_alignof(uint64_t),
              "atomic store payload must retain natural uint64_t alignment");
static_assert(iree_alignof(iree_hal_replay_atomic_rmw_params_payload_t) ==
                  iree_alignof(uint64_t),
