...
hipError_t hipGetDevicePropertiesR0600(hipDeviceProp_t* prop, int deviceId) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGetDevicePropertiesR0600");
  }
...
hipError_t hipMemcpyWithStream(void* dst, const void* src, size_t sizeBytes,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyWithStream");
  }
...
hipError_t hipMallocAsync(void** dev_ptr, size_t size, hipStream_t stream) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMallocAsync");
  }
...
hipError_t hipFreeAsync(void* dev_ptr, hipStream_t stream) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipFreeAsync");
  }
...
hipError_t hipMemPoolCreate(hipMemPool_t* mem_pool,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemPoolCreate");
  }
...
hipError_t hipMemPoolDestroy(hipMemPool_t mem_pool) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemPoolDestroy");
  }
...
hipError_t hipDeviceGetDefaultMemPool(hipMemPool_t* mem_pool, int device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetDefaultMemPool");
  }
...
hipError_t hipDeviceSetMemPool(int device, hipMemPool_t mem_pool) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceSetMemPool");
  }
...
hipError_t hipDeviceGetMemPool(hipMemPool_t* mem_pool, int device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetMemPool");
  }
  hipError_t _ret = fn ? fn(mem_pool, device) : 1;
...
hipError_t hipMallocFromPoolAsync(void** dev_ptr, size_t size,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMallocFromPoolAsync");
  }
...
hipError_t hipMemPoolSetAttribute(hipMemPool_t mem_pool, hipMemPoolAttr attr,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemPoolSetAttribute");
  }
...
hipError_t hipMemPoolGetAttribute(hipMemPool_t mem_pool, hipMemPoolAttr attr,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemPoolGetAttribute");
  }
  hipError_t _ret = fn ? fn(mem_pool, attr, value) : 1;
...
hipError_t hipMemPoolTrimTo(hipMemPool_t mem_pool, size_t min_bytes_to_hold) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemPoolTrimTo");
  }
...
hipError_t hipMemcpy2D(void* dst, size_t dpitch, const void* src, size_t spitch,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpy2D");
  }
...
hipError_t hipMemcpy2DAsync(void* dst, size_t dpitch, const void* src,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpy2DAsync");
  }
  hipError_t _ret =
...
hipError_t hipMemcpyDtoD(hipDeviceptr_t dst, hipDeviceptr_t src,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyDtoD");
  }
...
hipError_t hipMemcpyDtoDAsync(hipDeviceptr_t dst, hipDeviceptr_t src,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyDtoDAsync");
  }
...
hipError_t hipMemcpyDtoH(void* dst, hipDeviceptr_t src, size_t sizeBytes) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyDtoH");
  }
  hipError_t _ret = fn ? fn(dst, src, sizeBytes) : 1;
...
hipError_t hipMemcpyDtoHAsync(void* dst, hipDeviceptr_t src, size_t sizeBytes,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyDtoHAsync");
  }
  hipError_t _ret = fn ? fn(dst, src, sizeBytes, stream) : 1;
...
hipError_t hipMemcpyHtoD(hipDeviceptr_t dst, const void* src,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyHtoD");
  }
  hipError_t _ret = fn ? fn(dst, src, sizeBytes) : 1;
...
hipError_t hipMemcpyHtoDAsync(hipDeviceptr_t dst, const void* src,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyHtoDAsync");
  }
  hipError_t _ret = fn ? fn(dst, src, sizeBytes, stream) : 1;
...
hipError_t hipMemset2D(void* dst, size_t pitch, int value, size_t width,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemset2D");
  }
...
hipError_t hipMemset2DAsync(void* dst, size_t pitch, int value, size_t width,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemset2DAsync");
  }
...
hipError_t hipMemsetD8(hipDeviceptr_t dst, unsigned char value, size_t count) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemsetD8");
  }
...
hipError_t hipMemsetD8Async(hipDeviceptr_t dst, unsigned char value,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemsetD8Async");
  }
...
hipError_t hipMemsetD16(hipDeviceptr_t dst, unsigned short value,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemsetD16");
  }
  hipError_t _ret = fn ? fn(dst, value, count) : 1;
...
hipError_t hipMemsetD16Async(hipDeviceptr_t dst, unsigned short value,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemsetD16Async");
  }
  hipError_t _ret = fn ? fn(dst, value, count, stream) : 1;
  pt_log(2,
...
hipError_t hipMemsetD32(hipDeviceptr_t dst, int value, size_t count) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemsetD32");
  }
  hipError_t _ret = fn ? fn(dst, value, count) : 1;
...
hipError_t hipMemsetD32Async(hipDeviceptr_t dst, int value, size_t count,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemsetD32Async");
  }
  hipError_t _ret = fn ? fn(dst, value, count, stream) : 1;
  pt_log(2,
...
hipError_t hipPointerGetAttributes(hipPointerAttribute_t* attributes,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipPointerGetAttributes");
  }
...
hipError_t hipPointerGetAttribute(void* data, int attribute,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipPointerGetAttribute");
  }
...
hipError_t hipDrvPointerGetAttributes(unsigned int numAttributes,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDrvPointerGetAttributes");
  }
...
hipError_t hipFuncSetAttribute(const void* func, int attr, int value) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipFuncSetAttribute");
  }
...
hipError_t hipFuncSetCacheConfig(const void* func, int config) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipFuncSetCacheConfig");
  }
...
hipError_t hipFuncSetSharedMemConfig(const void* func, int config) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipFuncSetSharedMemConfig");
  }
  hipError_t _ret = fn ? fn(func, config) : 1;
...
hipError_t hipFuncGetAttributes(void* attr, const void* func) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipFuncGetAttributes");
  }
...
hipError_t hipFuncGetAttribute(int* value, int attrib, hipFunction_t hfunc) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipFuncGetAttribute");
  }
...
hipError_t hipOccupancyMaxPotentialBlockSize(int* gridSize, int* blockSize,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipOccupancyMaxPotentialBlockSize");
  }
  hipError_t _ret =
...
hipError_t hipDeviceGetStreamPriorityRange(int* leastPriority,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetStreamPriorityRange");
  }
...
hipError_t hipDeviceCanAccessPeer(int* canAccessPeer, int deviceId,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceCanAccessPeer");
  }
...
hipError_t hipDeviceEnablePeerAccess(int peerDeviceId, unsigned int flags) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceEnablePeerAccess");
  }
...
hipError_t hipDeviceDisablePeerAccess(int peerDeviceId) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceDisablePeerAccess");
  }
...
hipError_t hipDeviceGetByPCIBusId(int* device, const char* pciBusId) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetByPCIBusId");
  }
...
hipError_t hipDeviceGetPCIBusId(char* pciBusId, int len, int device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetPCIBusId");
  }
...
hipError_t hipIpcGetMemHandle(hipIpcMemHandle_t* handle, void* devPtr) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipIpcGetMemHandle");
  }
...
hipError_t hipIpcOpenMemHandle(void** devPtr, hipIpcMemHandle_t handle,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipIpcOpenMemHandle");
  }
...
hipError_t hipIpcCloseMemHandle(void* devPtr) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipIpcCloseMemHandle");
  }
...
hipError_t hipIpcGetEventHandle(hipIpcEventHandle_t* handle, hipEvent_t event) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipIpcGetEventHandle");
  }
...
hipError_t hipIpcOpenEventHandle(hipEvent_t* event,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipIpcOpenEventHandle");
  }
...
hipError_t hipLaunchHostFunc(hipStream_t stream, hipHostFn_t fn_cb,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipLaunchHostFunc");
  }
...
hipError_t hipStreamAddCallback(hipStream_t stream,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamAddCallback");
  }
...
hipError_t hipStreamGetCaptureInfo(hipStream_t stream,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamGetCaptureInfo");
  }
...
hipError_t hipStreamBeginCapture(hipStream_t stream, int mode) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamBeginCapture");
  }
...
hipError_t hipStreamEndCapture(hipStream_t stream, hipGraph_t* pGraph) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamEndCapture");
  }
...
hipError_t hipGraphCreate(hipGraph_t* pGraph, unsigned int flags) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphCreate");
  }
...
hipError_t hipGraphDestroy(hipGraph_t graph) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphDestroy");
  }
...
hipError_t hipGraphInstantiate(hipGraphExec_t* pGraphExec, hipGraph_t graph,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphInstantiate");
  }
  hipError_t _ret =
...
hipError_t hipGraphLaunch(hipGraphExec_t graphExec, hipStream_t stream) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphLaunch");
  }
...
hipError_t hipGraphExecDestroy(hipGraphExec_t graphExec) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphExecDestroy");
  }
...
hipError_t hipHostRegister(void* hostPtr, size_t sizeBytes,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipHostRegister");
  }
...
hipError_t hipHostUnregister(void* hostPtr) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipHostUnregister");
  }
...
hipError_t hipHostGetDevicePointer(void** devPtr, void* hostPtr,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipHostGetDevicePointer");
  }
...
hipError_t hipHostGetFlags(unsigned int* flagsPtr, void* hostPtr) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipHostGetFlags");
  }
...
hipError_t hipModuleLoadDataEx(hipModule_t* module, const void* image,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipModuleLoadDataEx");
  }
  hipError_t _ret =
...
hipError_t hipMallocPitch(void** ptr, size_t* pitch, size_t width,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMallocPitch");
  }
...
hipError_t hipMallocManaged(void** dev_ptr, size_t size, unsigned int flags) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMallocManaged");
  }
...
hipError_t hipMemPrefetchAsync(const void* dev_ptr, size_t count, int device,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemPrefetchAsync");
  }
...
hipError_t hipMemAdvise(const void* dev_ptr, size_t count, int advice,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemAdvise");
  }
...
hipError_t hipMemRangeGetAttribute(void* data, size_t dataSize, int attribute,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemRangeGetAttribute");
  }
...
hipError_t hipCtxCreate(hipCtx_t* ctx, unsigned int flags, hipDevice_t device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipCtxCreate");
  }
...
hipError_t hipCtxDestroy(hipCtx_t ctx) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipCtxDestroy");
  }
...
hipError_t hipCtxGetCurrent(hipCtx_t* ctx) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipCtxGetCurrent");
  }
  hipError_t _ret = fn ? fn(ctx) : 1;
...
hipError_t hipCtxSetCurrent(hipCtx_t ctx) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipCtxSetCurrent");
  }
  hipError_t _ret = fn ? fn(ctx) : 1;
...
hipError_t hipCtxPushCurrent(hipCtx_t ctx) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipCtxPushCurrent");
  }
  hipError_t _ret = fn ? fn(ctx) : 1;
...
hipError_t hipCtxPopCurrent(hipCtx_t* ctx) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipCtxPopCurrent");
  }
  hipError_t _ret = fn ? fn(ctx) : 1;
...
hipError_t hipCtxGetDevice(hipDevice_t* device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipCtxGetDevice");
  }
...
hipError_t hipCtxSynchronize(void) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipCtxSynchronize");
  }
...
hipError_t hipDevicePrimaryCtxRetain(hipCtx_t* pctx, hipDevice_t dev) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDevicePrimaryCtxRetain");
  }
...
hipError_t hipDevicePrimaryCtxRelease(hipDevice_t dev) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDevicePrimaryCtxRelease");
  }
...
hipError_t hipDevicePrimaryCtxSetFlags(hipDevice_t dev, unsigned int flags) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDevicePrimaryCtxSetFlags");
  }
...
hipError_t hipDevicePrimaryCtxGetState(hipDevice_t dev, unsigned int* flags,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDevicePrimaryCtxGetState");
  }
...
hipError_t hipDevicePrimaryCtxReset(hipDevice_t dev) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDevicePrimaryCtxReset");
  }
  hipError_t _ret = fn ? fn(dev) : 1;
...
hipError_t hipDeviceGet(hipDevice_t* device, int ordinal) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGet");
  }
...
hipError_t hipDeviceComputeCapability(int* major, int* minor,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceComputeCapability");
  }
...
hipError_t hipDeviceTotalMem(size_t* bytes, hipDevice_t device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceTotalMem");
  }
...
hipError_t hipMemGetAddressRange(hipDeviceptr_t* pbase, size_t* psize,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemGetAddressRange");
  }
...
hipError_t hipMemAllocPitch(hipDeviceptr_t* dptr, size_t* pitch,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemAllocPitch");
  }
  hipError_t _ret =
...
hipError_t hipMemAlloc(hipDeviceptr_t* dptr, size_t size) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemAlloc");
  }
...
hipError_t hipMemFree(hipDeviceptr_t dptr) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemFree");
  }
...
hipError_t hipMemcpyFromSymbol(void* dst, const void* symbol, size_t sizeBytes,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyFromSymbol");
  }
...
hipError_t hipMemcpyFromSymbolAsync(void* dst, const void* symbol,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyFromSymbolAsync");
  }
...
hipError_t hipMemcpyToSymbol(const void* symbol, const void* src,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyToSymbol");
  }
...
hipError_t hipMemcpyToSymbolAsync(const void* symbol, const void* src,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyToSymbolAsync");
  }
...
hipError_t hipGetSymbolAddress(void** devPtr, const void* symbol) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGetSymbolAddress");
  }
...
hipError_t hipGetSymbolSize(size_t* size, const void* symbol) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGetSymbolSize");
  }
...
hipError_t hipMemcpyPeer(void* dst, int dstDeviceId, const void* src,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyPeer");
  }
...
hipError_t hipMemcpyPeerAsync(void* dst, int dstDeviceId, const void* src,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyPeerAsync");
  }
  hipError_t _ret =
...
hipError_t hipBindTexture(size_t* offset, const void* tex, const void* devPtr,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipBindTexture");
  }
...
hipError_t hipUnbindTexture(const void* tex) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipUnbindTexture");
  }
...
hipError_t hipExtLaunchKernel(const void* function_address, dim3 numBlocks,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipExtLaunchKernel");
  }
  hipError_t _ret =
...
hipError_t hipDeviceSetCacheConfig(int cacheConfig) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceSetCacheConfig");
  }
...
hipError_t hipDeviceGetCacheConfig(int* cacheConfig) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetCacheConfig");
  }
  hipError_t _ret = fn ? fn(cacheConfig) : 1;
...
hipError_t hipDeviceSetSharedMemConfig(int config) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceSetSharedMemConfig");
  }
...
hipError_t hipDeviceGetSharedMemConfig(int* pConfig) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetSharedMemConfig");
  }
...
hipError_t hipDeviceGetLimit(size_t* pValue, int limit) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetLimit");
  }
...
hipError_t hipDeviceSetLimit(int limit, size_t value) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceSetLimit");
  }
...
hipError_t hipDeviceGetUuid(void* uuid, hipDevice_t device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetUuid");
  }
...
hipError_t hipSetDeviceFlags(unsigned int flags) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipSetDeviceFlags");
  }
...
hipError_t hipGetDeviceFlags(unsigned int* flags) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGetDeviceFlags");
  }
  hipError_t _ret = fn ? fn(flags) : 1;
...
hipError_t hipChooseDevice(int* device, const hipDeviceProp_t* prop) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipChooseDevice");
  }
...
hipError_t hipImportExternalMemory(hipExternalMemory_t* extMem_out,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipImportExternalMemory");
  }
...
hipError_t hipExternalMemoryGetMappedBuffer(void** devPtr,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipExternalMemoryGetMappedBuffer");
  }
...
hipError_t hipDestroyExternalMemory(hipExternalMemory_t extMem) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDestroyExternalMemory");
  }
...
hipError_t hipImportExternalSemaphore(hipExternalSemaphore_t* extSem_out,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipImportExternalSemaphore");
  }
...
hipError_t hipSignalExternalSemaphoresAsync(
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipSignalExternalSemaphoresAsync");
  }
...
hipError_t hipWaitExternalSemaphoresAsync(
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipWaitExternalSemaphoresAsync");
  }
  hipError_t _ret = fn ? fn(extSemArray, paramsArray, numExtSems, stream) : 1;
...
hipError_t hipDestroyExternalSemaphore(hipExternalSemaphore_t extSem) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDestroyExternalSemaphore");
  }
...
hipError_t hipExtGetLastError(void) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipExtGetLastError");
  }
  hipError_t _ret = fn ? fn() : 1;
...
const char* hipDrvGetErrorString(hipError_t hipError, const char** pStr) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDrvGetErrorString");
  }
...
const char* hipDrvGetErrorName(hipError_t hipError, const char** pStr) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDrvGetErrorName");
  }
  const char* _ret = fn ? fn(hipError, pStr) : "unknown";
...
hipError_t hipThreadExchangeStreamCaptureMode(int* mode) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipThreadExchangeStreamCaptureMode");
  }
...
hipError_t hipMemPoolSetAccess(hipMemPool_t memPool, const void* descList,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemPoolSetAccess");
  }
...
hipError_t hipMemPoolGetAccess(int* flags, hipMemPool_t memPool,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemPoolGetAccess");
  }
...
hipError_t hipMemPoolExportToShareableHandle(void* shareableHandle,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemPoolExportToShareableHandle");
  }
...
hipError_t hipMemPoolExportPointer(void* exportData, void* dev_ptr) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemPoolExportPointer");
  }
...
hipError_t hipMemPoolImportPointer(void** dev_ptr, hipMemPool_t memPool,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemPoolImportPointer");
  }
...
hipError_t hipGraphInstantiateWithFlags(hipGraphExec_t* pGraphExec,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphInstantiateWithFlags");
  }
...
hipError_t hipGraphUpload(hipGraphExec_t graphExec, hipStream_t stream) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphUpload");
  }
  hipError_t _ret = fn ? fn(graphExec, stream) : 1;
...
hipError_t hipGraphAddMemcpyNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphAddMemcpyNode");
  }
  hipError_t _ret =
...
hipError_t hipGraphAddMemsetNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphAddMemsetNode");
  }
  hipError_t _ret =
...
hipError_t hipGraphAddKernelNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphAddKernelNode");
  }
  hipError_t _ret =
...
hipError_t hipGraphGetNodes(hipGraph_t graph, hipGraphNode_t* nodes,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphGetNodes");
  }
...
hipError_t hipGraphGetRootNodes(hipGraph_t graph, hipGraphNode_t* pRootNodes,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphGetRootNodes");
  }
...
hipError_t hipGraphNodeGetType(hipGraphNode_t node, int* pType) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphNodeGetType");
  }
...
hipError_t hipStreamGetCaptureInfo_v2(hipStream_t stream,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamGetCaptureInfo_v2");
  }
...
hipError_t hipLaunchCooperativeKernel(const void* f, dim3 gridDim,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipLaunchCooperativeKernel");
  }
  hipError_t _ret =
...
hipError_t hipMallocArray(hipArray_t* array, const void* desc, size_t width,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMallocArray");
  }
...
hipError_t hipFreeArray(hipArray_t array) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipFreeArray");
  }
...
hipError_t hipMalloc3DArray(hipArray_t* array, const void* desc, void* extent,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMalloc3DArray");
  }
...
hipError_t hipArrayGetInfo(void* desc, void* extent, unsigned int* flags,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipArrayGetInfo");
  }
...
hipError_t hipMemcpy3D(const void* p) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpy3D");
  }
...
hipError_t hipMemcpy3DAsync(const void* p, hipStream_t stream) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpy3DAsync");
  }
...
hipError_t hipMemcpyToArray(hipArray_t dst, size_t wOffset, size_t hOffset,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyToArray");
  }
...
hipError_t hipMemcpyFromArray(void* dst, hipArray_t src, size_t wOffset,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyFromArray");
  }
...
hipError_t hipMemcpy2DToArray(hipArray_t dst, size_t wOffset, size_t hOffset,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpy2DToArray");
  }
  hipError_t _ret =
...
hipError_t hipMemcpy2DFromArray(void* dst, size_t dpitch, hipArray_t src,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpy2DFromArray");
  }
  hipError_t _ret =
...
hipError_t hipMemcpyAtoH(void* dst, hipArray_t srcArray, size_t srcOffset,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyAtoH");
  }
...
hipError_t hipMemcpyHtoA(hipArray_t dstArray, size_t dstOffset,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemcpyHtoA");
  }
...
hipError_t hipMallocMipmappedArray(hipMipmappedArray_t* mipmappedArray,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMallocMipmappedArray");
  }
...
hipError_t hipFreeMipmappedArray(hipMipmappedArray_t mipmappedArray) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipFreeMipmappedArray");
  }
...
hipError_t hipGetMipmappedArrayLevel(hipArray_t* levelArray,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGetMipmappedArrayLevel");
  }
...
hipError_t hipExtMallocWithFlags(void** ptr, size_t sizeBytes,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipExtMallocWithFlags");
  }
...
hipError_t hipRuntimeGetVersion_r(int* runtimeVersion) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipRuntimeGetVersion_r");
  }
...
hipError_t hipCreateSurfaceObject(void* pSurfObject, const void* pResDesc) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipCreateSurfaceObject");
  }
...
hipError_t hipDestroySurfaceObject(unsigned long long surfaceObject) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDestroySurfaceObject");
  }
...
hipError_t hipCreateTextureObject(void* pTexObject, const void* pResDesc,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipCreateTextureObject");
  }
...
hipError_t hipDestroyTextureObject(unsigned long long textureObject) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDestroyTextureObject");
  }
...
hipError_t hipGetTextureObjectResourceDesc(void* pResDesc,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGetTextureObjectResourceDesc");
  }
...
hipError_t hipGetTextureObjectTextureDesc(void* pTexDesc,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGetTextureObjectTextureDesc");
  }
...
hipError_t hipGetChannelDesc(void* desc, hipArray_t array) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGetChannelDesc");
  }
...
hipError_t hipTexRefSetArray(void* texRef, hipArray_t array,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipTexRefSetArray");
  }
...
hipError_t hipTexRefSetAddress(size_t* offset, void* texRef,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipTexRefSetAddress");
  }
...
hipError_t hipTexRefSetAddress2D(void* texRef, const void* desc,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipTexRefSetAddress2D");
  }
...
hipError_t hipTexRefSetFormat(void* texRef, int format, int numComponents) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipTexRefSetFormat");
  }
...
hipError_t hipTexRefSetFlags(void* texRef, unsigned int flags) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipTexRefSetFlags");
  }
...
hipError_t hipTexRefSetFilterMode(void* texRef, int fm) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipTexRefSetFilterMode");
  }
...
hipError_t hipTexRefSetAddressMode(void* texRef, int dim, int am) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipTexRefSetAddressMode");
  }
...
hipError_t hipTexRefGetAddress(hipDeviceptr_t* dptr, const void* texRef) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipTexRefGetAddress");
  }
...
hipError_t hipModuleGetTexRef(void** texRef, hipModule_t hmod,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipModuleGetTexRef");
  }
...
void __hipRegisterSurface(void** fatCubinHandle, char* hostVar,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "__hipRegisterSurface");
  }
  if (fn) {
    fn(fatCubinHandle, hostVar, deviceAddress, deviceName, dim, ext);
  }
...
void __hipRegisterTexture(void** fatCubinHandle, char* hostVar,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "__hipRegisterTexture");
  }
  if (fn) {
...
void __hipRegisterManagedVar(void* hipModule, void** pointer, void* init_value,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "__hipRegisterManagedVar");
  }
  if (fn) {
    fn(hipModule, pointer, init_value, name, size, align);
  }
...
hipError_t hipStreamUpdateCaptureDependencies(hipStream_t stream,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamUpdateCaptureDependencies");
  }
...
hipError_t hipUserObjectCreate(void** object_out, void* ptr,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipUserObjectCreate");
  }
  hipError_t _ret =
...
hipError_t hipUserObjectRelease(void* object, unsigned int count) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipUserObjectRelease");
  }
...
hipError_t hipUserObjectRetain(void* object, unsigned int count) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipUserObjectRetain");
  }
  hipError_t _ret = fn ? fn(object, count) : 1;
...
hipError_t hipGraphRetainUserObject(hipGraph_t graph, void* object,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphRetainUserObject");
  }
...
hipError_t hipGraphReleaseUserObject(hipGraph_t graph, void* object,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphReleaseUserObject");
  }
...
hipError_t hipGraphAddHostNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphAddHostNode");
  }
  hipError_t _ret =
      fn ? fn(pGraphNode, graph, pDependencies, numDependencies, pNodeParams)
         : 1;
...
hipError_t hipGraphAddEventRecordNode(hipGraphNode_t* pGraphNode,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphAddEventRecordNode");
  }
  hipError_t _ret =
...
hipError_t hipGraphAddEventWaitNode(hipGraphNode_t* pGraphNode,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphAddEventWaitNode");
  }
  hipError_t _ret =
      fn ? fn(pGraphNode, graph, pDependencies, numDependencies, event) : 1;
...
hipError_t hipGraphAddChildGraphNode(hipGraphNode_t* pGraphNode,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphAddChildGraphNode");
  }
  hipError_t _ret =
...
hipError_t hipGraphAddEmptyNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphAddEmptyNode");
  }
  hipError_t _ret =
...
hipError_t hipGraphAddDependencies(hipGraph_t graph, const hipGraphNode_t* from,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphAddDependencies");
  }
...
hipError_t hipGraphRemoveDependencies(hipGraph_t graph,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphRemoveDependencies");
  }
  hipError_t _ret = fn ? fn(graph, from, to, numDependencies) : 1;
...
hipError_t hipGraphDestroyNode(hipGraphNode_t node) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphDestroyNode");
  }
...
hipError_t hipGraphClone(hipGraph_t* pGraphClone, hipGraph_t originalGraph) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphClone");
  }
...
hipError_t hipGraphNodeFindInClone(hipGraphNode_t* pNode,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphNodeFindInClone");
  }
...
hipError_t hipGraphNodeGetDependencies(hipGraphNode_t node,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphNodeGetDependencies");
  }
...
hipError_t hipGraphNodeGetDependentNodes(hipGraphNode_t node,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphNodeGetDependentNodes");
  }
...
hipError_t hipGraphGetEdges(hipGraph_t graph, hipGraphNode_t* from,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphGetEdges");
  }
...
hipError_t hipGraphExecUpdate(hipGraphExec_t hGraphExec, hipGraph_t hGraph,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphExecUpdate");
  }
  hipError_t _ret =
...
hipError_t hipGraphKernelNodeGetParams(hipGraphNode_t node, void* pNodeParams) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphKernelNodeGetParams");
  }
...
hipError_t hipGraphKernelNodeSetParams(hipGraphNode_t node,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphKernelNodeSetParams");
  }
  hipError_t _ret = fn ? fn(node, pNodeParams) : 1;
...
hipError_t hipGraphExecKernelNodeSetParams(hipGraphExec_t hGraphExec,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphExecKernelNodeSetParams");
  }
...
hipError_t hipGraphMemcpyNodeGetParams(hipGraphNode_t node, void* pNodeParams) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphMemcpyNodeGetParams");
  }
  hipError_t _ret = fn ? fn(node, pNodeParams) : 1;
...
hipError_t hipGraphMemcpyNodeSetParams(hipGraphNode_t node,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphMemcpyNodeSetParams");
  }
  hipError_t _ret = fn ? fn(node, pNodeParams) : 1;
...
hipError_t hipGraphMemsetNodeGetParams(hipGraphNode_t node, void* pNodeParams) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphMemsetNodeGetParams");
  }
  hipError_t _ret = fn ? fn(node, pNodeParams) : 1;
...
hipError_t hipGraphMemsetNodeSetParams(hipGraphNode_t node,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphMemsetNodeSetParams");
  }
  hipError_t _ret = fn ? fn(node, pNodeParams) : 1;
...
hipError_t hipGraphHostNodeGetParams(hipGraphNode_t node, void* pNodeParams) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphHostNodeGetParams");
  }
  hipError_t _ret = fn ? fn(node, pNodeParams) : 1;
...
hipError_t hipGraphHostNodeSetParams(hipGraphNode_t node,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphHostNodeSetParams");
  }
  hipError_t _ret = fn ? fn(node, pNodeParams) : 1;
...
hipError_t hipGraphChildGraphNodeGetGraph(hipGraphNode_t node,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphChildGraphNodeGetGraph");
  }
...
hipError_t hipGraphEventRecordNodeGetEvent(hipGraphNode_t node,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphEventRecordNodeGetEvent");
  }
...
hipError_t hipGraphEventRecordNodeSetEvent(hipGraphNode_t node,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphEventRecordNodeSetEvent");
  }
...
hipError_t hipGraphEventWaitNodeGetEvent(hipGraphNode_t node,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphEventWaitNodeGetEvent");
  }
  hipError_t _ret = fn ? fn(node, event_out) : 1;
...
hipError_t hipGraphEventWaitNodeSetEvent(hipGraphNode_t node,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphEventWaitNodeSetEvent");
  }
  hipError_t _ret = fn ? fn(node, event) : 1;
...
hipError_t hipGraphDebugDotPrint(hipGraph_t graph, const char* path,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphDebugDotPrint");
  }
...
hipError_t hipGraphAddMemFreeNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphAddMemFreeNode");
  }
  hipError_t _ret =
...
hipError_t hipGraphAddMemAllocNode(hipGraphNode_t* pGraphNode, hipGraph_t graph,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphAddMemAllocNode");
  }
  hipError_t _ret =
      fn ? fn(pGraphNode, graph, pDependencies, numDependencies, pNodeParams)
         : 1;
...
hipError_t hipGraphMemAllocNodeGetParams(hipGraphNode_t node,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphMemAllocNodeGetParams");
  }
  hipError_t _ret = fn ? fn(node, pNodeParams) : 1;
...
hipError_t hipGraphMemFreeNodeGetParams(hipGraphNode_t node, void* dev_ptr) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphMemFreeNodeGetParams");
  }
...
hipError_t hipDeviceGraphMemTrim(int device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGraphMemTrim");
  }
  hipError_t _ret = fn ? fn(device) : 1;
...
hipError_t hipDeviceGetGraphMemAttribute(int device, int attr, void* value) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetGraphMemAttribute");
  }
...
hipError_t hipDeviceSetGraphMemAttribute(int device, int attr, void* value) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceSetGraphMemAttribute");
  }
  hipError_t _ret = fn ? fn(device, attr, value) : 1;
...
hipError_t hipStreamGetDevice(hipStream_t stream, hipDevice_t* device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamGetDevice");
  }
...
hipError_t hipStreamAttachMemAsync(hipStream_t stream, void* dev_ptr,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamAttachMemAsync");
  }
...
const char* hipKernelNameRef(const void* hostFunction) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipKernelNameRef");
  }
...
const char* hipKernelNameRefByPtr(const void* hostFunction,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipKernelNameRefByPtr");
  }
...
hipError_t hipLaunchKernelGGL(const void* func, dim3 gridDim, dim3 blockDim,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipLaunchKernelGGL");
  }
  hipError_t _ret =
...
hipError_t hipProfilerStart(void) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipProfilerStart");
  }
  hipError_t _ret = fn ? fn() : 1;
...
hipError_t hipProfilerStop(void) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipProfilerStop");
  }
  hipError_t _ret = fn ? fn() : 1;
...
hipError_t hipApiVersion(unsigned int* apiVersion) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipApiVersion");
  }
...
hipError_t hipMallocHost(void** ptr, size_t size) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMallocHost");
  }
...
hipError_t hipFreeHost(void* ptr) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipFreeHost");
  }
...
hipError_t hipConfigureCall(dim3 gridDim, dim3 blockDim, size_t sharedMem,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipConfigureCall");
  }
...
hipError_t hipSetupArgument(const void* arg, size_t size, size_t offset) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipSetupArgument");
  }
...
hipError_t hipLaunchByPtr(const void* func) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipLaunchByPtr");
  }
...
hipError_t hipExtLaunchMultiKernelMultiDevice(void* launchParamsList,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipExtLaunchMultiKernelMultiDevice");
  }
  hipError_t _ret = fn ? fn(launchParamsList, numDevices, flags) : 1;
...
hipError_t hipMemGetAllocationGranularity(size_t* granularity, const void* prop,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemGetAllocationGranularity");
  }
...
hipError_t hipMemAddressReserve(void** ptr, size_t size, size_t alignment,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemAddressReserve");
  }
...
hipError_t hipMemAddressFree(void* devPtr, size_t size) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemAddressFree");
  }
...
hipError_t hipMemCreate(void* handle, size_t size, const void* prop,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemCreate");
  }
...
hipError_t hipMemRelease(void* handle) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemRelease");
  }
...
hipError_t hipMemMap(void* ptr, size_t size, size_t offset, void* handle,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemMap");
  }
...
hipError_t hipMemUnmap(void* ptr, size_t size) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemUnmap");
  }
  hipError_t _ret = fn ? fn(ptr, size) : 1;
...
hipError_t hipMemSetAccess(void* ptr, size_t size, const void* desc,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemSetAccess");
  }
...
hipError_t hipMemGetAccess(unsigned long long* flags, const void* location,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemGetAccess");
  }
...
hipError_t hipMemExportToShareableHandle(void* shareableHandle, void* handle,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemExportToShareableHandle");
  }
...
hipError_t hipMemImportFromShareableHandle(void* handle, void* osHandle,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemImportFromShareableHandle");
  }
...
hipError_t hipMemRetainAllocationHandle(void* handle, void* addr) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemRetainAllocationHandle");
  }
...
hipError_t hipMemPtrGetInfo(void* ptr, size_t* size) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemPtrGetInfo");
  }
  hipError_t _ret = fn ? fn(ptr, size) : 1;
...
hipError_t hipExtStreamCreateWithCUMask(hipStream_t* stream,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipExtStreamCreateWithCUMask");
  }
...
hipError_t hipExtStreamGetCUMask(hipStream_t stream, uint32_t cuMaskSize,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipExtStreamGetCUMask");
  }
  hipError_t _ret = fn ? fn(stream, cuMaskSize, cuMask) : 1;
...
hipError_t hipHccModuleLaunchKernel(
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipHccModuleLaunchKernel");
  }
  hipError_t _ret =
...
hipError_t hipDeviceGetUuidString(char* uuid, hipDevice_t device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetUuidString");
  }
  hipError_t _ret = fn ? fn(uuid, device) : 1;
...
hipError_t hipMalloc3D(void* pitchedDevPtr, void* extent) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMalloc3D");
  }
...
hipError_t hipMemset3D(void* pitchedDevPtr, int value, void* extent) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemset3D");
  }
...
hipError_t hipMemset3DAsync(void* pitchedDevPtr, int value, void* extent,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipMemset3DAsync");
  }
...
hipError_t hipGetArrayDescriptor(void* pArrayDescriptor, hipArray_t array) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGetArrayDescriptor");
  }
...
hipError_t hipArrayCreate(hipArray_t* pHandle, const void* pAllocateArray) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipArrayCreate");
  }
...
hipError_t hipArray3DCreate(hipArray_t* pHandle, const void* pAllocateArray) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipArray3DCreate");
  }
  hipError_t _ret = fn ? fn(pHandle, pAllocateArray) : 1;
...
hipError_t hipArrayGetDescriptor(void* pArrayDescriptor, hipArray_t array) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipArrayGetDescriptor");
  }
  hipError_t _ret = fn ? fn(pArrayDescriptor, array) : 1;
...
hipError_t hipArray3DGetDescriptor(void* pArrayDescriptor, hipArray_t array) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipArray3DGetDescriptor");
  }
  hipError_t _ret = fn ? fn(pArrayDescriptor, array) : 1;
...
hipError_t hipDeviceGetDefaultMemPoolR0600(hipMemPool_t* memPool, int device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetDefaultMemPoolR0600");
  }
...
hipError_t hipModuleLaunchCooperativeKernel(
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipModuleLaunchCooperativeKernel");
  }
  hipError_t _ret =
...
hipError_t hipDeviceGetP2PAttribute(int* value, int attr, int srcDevice,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetP2PAttribute");
  }
...
hipError_t hipDeviceGetArchConfig(int* major, int* minor, hipDevice_t device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetArchConfig");
  }
  hipError_t _ret = fn ? fn(major, minor, device) : 1;
...
hipError_t hipDrvMemcpy2DUnaligned(const void* pCopy) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDrvMemcpy2DUnaligned");
  }
...
hipError_t hipDrvMemcpy3D(const void* p) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDrvMemcpy3D");
  }
  hipError_t _ret = fn ? fn(p) : 1;
...
hipError_t hipDrvMemcpy3DAsync(const void* p, hipStream_t stream) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDrvMemcpy3DAsync");
  }
  hipError_t _ret = fn ? fn(p, stream) : 1;
...
hipError_t hipModuleLoadGlobal(hipDeviceptr_t* dptr, size_t* bytes,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipModuleLoadGlobal");
  }
...
hipError_t hipDeviceGetAttributeByName(int* value, const char* attr_name,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDeviceGetAttributeByName");
  }
...
hipError_t hipStreamWriteValue32(hipStream_t stream, void* ptr, uint32_t value,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamWriteValue32");
  }
...
hipError_t hipStreamWriteValue64(hipStream_t stream, void* ptr, uint64_t value,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamWriteValue64");
  }
  hipError_t _ret = fn ? fn(stream, ptr, value, flags) : 1;
...
hipError_t hipStreamWaitValue32(hipStream_t stream, void* ptr, uint32_t value,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamWaitValue32");
  }
...
hipError_t hipStreamWaitValue64(hipStream_t stream, void* ptr, uint64_t value,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamWaitValue64");
  }
  hipError_t _ret = fn ? fn(stream, ptr, value, flags, mask) : 1;
...
hipError_t hipDrvMemcpy2D(const void* pCopy) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipDrvMemcpy2D");
  }
  hipError_t _ret = fn ? fn(pCopy) : 1;
...
hipError_t hipRtcCompileProgram(void* prog, int numOptions,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipRtcCompileProgram");
  }
...
hipError_t hipRtcCreateProgram(void** prog, const char* src, const char* name,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipRtcCreateProgram");
  }
  hipError_t _ret =
...
hipError_t hipRtcDestroyProgram(void** prog) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipRtcDestroyProgram");
  }
...
hipError_t hipRtcGetCode(void* prog, char* code) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipRtcGetCode");
  }
...
hipError_t hipRtcGetCodeSize(void* prog, size_t* codeSizeRet) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipRtcGetCodeSize");
  }
...
hipError_t hipRtcGetProgramLog(void* prog, char* log) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipRtcGetProgramLog");
  }
...
hipError_t hipRtcGetProgramLogSize(void* prog, size_t* logSizeRet) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipRtcGetProgramLogSize");
  }
...
hipError_t hipGetDeviceProperties_v2(void* prop, int device) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGetDeviceProperties_v2");
  }
...
hipError_t hipGLGetDevices(unsigned int* pHipDeviceCount, int* pHipDevices,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGLGetDevices");
  }
  hipError_t _ret =
...
hipError_t hipGraphicsGLRegisterBuffer(void** resource, unsigned int buffer,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphicsGLRegisterBuffer");
  }
...
hipError_t hipGraphicsGLRegisterImage(void** resource, unsigned int image,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphicsGLRegisterImage");
  }
...
hipError_t hipGraphicsMapResources(int count, void** resources,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphicsMapResources");
  }
...
hipError_t hipGraphicsUnmapResources(int count, void** resources,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphicsUnmapResources");
  }
  hipError_t _ret = fn ? fn(count, resources, stream) : 1;
...
hipError_t hipGraphicsUnregisterResource(void* resource) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGraphicsUnregisterResource");
  }
...
hipError_t hipGetStreamDeviceId(hipStream_t stream, int* deviceId) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipGetStreamDeviceId");
  }
...
hipError_t hipStreamIsCapturing(hipStream_t stream,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamIsCapturing");
  }
...
hipError_t hipStreamCreateWithPriority(hipStream_t* stream, unsigned int flags,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamCreateWithPriority");
  }
...
hipError_t hipStreamGetPriority(hipStream_t stream, int* priority) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamGetPriority");
  }
...
hipError_t hipStreamGetFlags(hipStream_t stream, unsigned int* flags) {
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "hipStreamGetFlags");
  }
...
hipError_t __hipPushCallConfiguration(dim3 gridDim, dim3 blockDim,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "__hipPushCallConfiguration");
  }
  hipError_t _ret = fn ? fn(gridDim, blockDim, sharedMem, stream) : 1;
...
hipError_t __hipPopCallConfiguration(dim3* gridDim, dim3* blockDim,
  ...
  static pfn fn = NULL;
  if (!fn) {
    fn = (pfn)dlsym(g_backend_lib, "__hipPopCallConfiguration");
  }
  hipError_t _ret = fn ? fn(gridDim, blockDim, sharedMem, stream) : 1;
