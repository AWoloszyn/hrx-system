...
static void loom_opt_print_agents_markdown(FILE* stream) {
  fprintf(
      ...
      "logical loop and specialize these controls with config values. The\n"
      "default compiler pipeline consumes both policies. To inspect the\n"
      "source transformation alone:\n"
      "\n"
      "```shell\n"
