...
class Types {
 public:
  ...
  // Appends the scalar or buffer/offset source value representation used by
  // ordinary function signatures and structured results. Kernel parameters
  // instead use get(), retaining the launch binding ABI.
