...
static iree_status_t loom_cmd_serialize_packet(
  ...
  if (loom_cmd_serialize_packet_is(build, packet,
    ...
    loom_cmd_serialize_constant(
        build, op, LOOM_CMD_SERIALIZE_VALUE_KIND_U32,
        (uint64_t)loom_cmd_core_constant_u32_value(loom_low_const_attrs(op))
            .i64);
    return iree_ok_status();
  }
  if (loom_cmd_serialize_packet_is(build, packet,
    ...
    loom_cmd_serialize_constant(
        build, op, LOOM_CMD_SERIALIZE_VALUE_KIND_U64,
        (uint64_t)loom_cmd_core_constant_u64_value(loom_low_const_attrs(op))
            .i64);
    return iree_ok_status();
  }
  if (loom_cmd_serialize_packet_is(build, packet,
    ...
    loom_cmd_serialize_constant(
        build, op, LOOM_CMD_SERIALIZE_VALUE_KIND_B8,
        (uint64_t)loom_cmd_core_constant_b8_value(loom_low_const_attrs(op))
            .i64);
    return iree_ok_status();
  }
  if (loom_cmd_serialize_packet_is(build, packet,
    ...
    loom_cmd_serialize_constant(
        build, op, LOOM_CMD_SERIALIZE_VALUE_KIND_B16,
        (uint64_t)loom_cmd_core_constant_b16_value(loom_low_const_attrs(op))
            .i64);
    return iree_ok_status();
  }
  if (loom_cmd_serialize_packet_is(build, packet,
    ...
    loom_cmd_serialize_constant(
        build, op, LOOM_CMD_SERIALIZE_VALUE_KIND_B32,
        (uint64_t)loom_cmd_core_constant_b32_value(loom_low_const_attrs(op))
            .i64);
    return iree_ok_status();
  }
  if (loom_cmd_serialize_packet_is(build, packet,
