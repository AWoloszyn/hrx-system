...
enum {
  LOOM_X86_TARGET_SYMBOL_ATTR_INDEX = 0,
  LOOM_X86_TARGET_KIND_ATTR_INDEX = 1,
  LOOM_X86_TARGET_CODEGEN_FORMAT_ATTR_INDEX = 2,
  LOOM_X86_TARGET_ARTIFACT_FORMAT_ATTR_INDEX = 3,
  LOOM_X86_TARGET_DEFAULT_POINTER_BITWIDTH_ATTR_INDEX = 4,
  LOOM_X86_TARGET_INDEX_BITWIDTH_ATTR_INDEX = 5,
  LOOM_X86_TARGET_OFFSET_BITWIDTH_ATTR_INDEX = 6,
  LOOM_X86_TARGET_MAX_WORKGROUP_SIZE_X_ATTR_INDEX = 7,
  LOOM_X86_TARGET_MAX_WORKGROUP_SIZE_Y_ATTR_INDEX = 8,
  LOOM_X86_TARGET_MAX_WORKGROUP_SIZE_Z_ATTR_INDEX = 9,
  LOOM_X86_TARGET_MAX_FLAT_WORKGROUP_SIZE_ATTR_INDEX = 10,
  LOOM_X86_TARGET_MAX_WORKGROUP_STORAGE_BYTES_ATTR_INDEX = 11,
  LOOM_X86_TARGET_SUBGROUP_SIZE_ATTR_INDEX = 12,
  LOOM_X86_TARGET_MAX_GRID_SIZE_X_ATTR_INDEX = 13,
  LOOM_X86_TARGET_MAX_GRID_SIZE_Y_ATTR_INDEX = 14,
  LOOM_X86_TARGET_MAX_GRID_SIZE_Z_ATTR_INDEX = 15,
  LOOM_X86_TARGET_MAX_FLAT_GRID_SIZE_ATTR_INDEX = 16,
  LOOM_X86_TARGET_MAX_WORKGROUP_COUNT_X_ATTR_INDEX = 17,
  LOOM_X86_TARGET_MAX_WORKGROUP_COUNT_Y_ATTR_INDEX = 18,
  LOOM_X86_TARGET_MAX_WORKGROUP_COUNT_Z_ATTR_INDEX = 19,
  LOOM_X86_TARGET_MEMORY_SPACE_GENERIC_ATTR_INDEX = 20,
  LOOM_X86_TARGET_MEMORY_SPACE_GLOBAL_ATTR_INDEX = 21,
  LOOM_X86_TARGET_MEMORY_SPACE_WORKGROUP_ATTR_INDEX = 22,
  LOOM_X86_TARGET_MEMORY_SPACE_CONSTANT_ATTR_INDEX = 23,
  LOOM_X86_TARGET_MEMORY_SPACE_PRIVATE_ATTR_INDEX = 24,
  LOOM_X86_TARGET_MEMORY_SPACE_HOST_ATTR_INDEX = 25,
  LOOM_X86_TARGET_MEMORY_SPACE_DESCRIPTOR_ATTR_INDEX = 26,
  LOOM_X86_TARGET_ABI_ATTR_INDEX = 27,
  LOOM_X86_TARGET_EXPORT_SYMBOL_ATTR_INDEX = 28,
  LOOM_X86_TARGET_LINKAGE_ATTR_INDEX = 29,
  LOOM_X86_TARGET_CONTRACT_SET_KEY_ATTR_INDEX = 30,
  LOOM_X86_TARGET_CONTRACT_FEATURE_BITS_ATTR_INDEX = 31,
};
#define loom_x86_target_symbol_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_SYMBOL_ATTR_INDEX})
...
#define loom_x86_target_kind_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_KIND_ATTR_INDEX})
...
#define loom_x86_target_codegen_format_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_CODEGEN_FORMAT_ATTR_INDEX})
...
#define loom_x86_target_artifact_format_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_ARTIFACT_FORMAT_ATTR_INDEX})
...
#define loom_x86_target_default_pointer_bitwidth_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_DEFAULT_POINTER_BITWIDTH_ATTR_INDEX})
...
#define loom_x86_target_index_bitwidth_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_INDEX_BITWIDTH_ATTR_INDEX})
...
#define loom_x86_target_offset_bitwidth_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_OFFSET_BITWIDTH_ATTR_INDEX})
...
#define loom_x86_target_max_workgroup_size_x_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MAX_WORKGROUP_SIZE_X_ATTR_INDEX})
...
#define loom_x86_target_max_workgroup_size_y_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MAX_WORKGROUP_SIZE_Y_ATTR_INDEX})
...
#define loom_x86_target_max_workgroup_size_z_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MAX_WORKGROUP_SIZE_Z_ATTR_INDEX})
...
#define loom_x86_target_max_flat_workgroup_size_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MAX_FLAT_WORKGROUP_SIZE_ATTR_INDEX})
...
#define loom_x86_target_max_workgroup_storage_bytes_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MAX_WORKGROUP_STORAGE_BYTES_ATTR_INDEX})
...
#define loom_x86_target_subgroup_size_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_SUBGROUP_SIZE_ATTR_INDEX})
...
#define loom_x86_target_max_grid_size_x_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MAX_GRID_SIZE_X_ATTR_INDEX})
...
#define loom_x86_target_max_grid_size_y_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MAX_GRID_SIZE_Y_ATTR_INDEX})
...
#define loom_x86_target_max_grid_size_z_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MAX_GRID_SIZE_Z_ATTR_INDEX})
...
#define loom_x86_target_max_flat_grid_size_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MAX_FLAT_GRID_SIZE_ATTR_INDEX})
...
#define loom_x86_target_max_workgroup_count_x_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MAX_WORKGROUP_COUNT_X_ATTR_INDEX})
...
#define loom_x86_target_max_workgroup_count_y_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MAX_WORKGROUP_COUNT_Y_ATTR_INDEX})
...
#define loom_x86_target_max_workgroup_count_z_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MAX_WORKGROUP_COUNT_Z_ATTR_INDEX})
...
#define loom_x86_target_memory_space_generic_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MEMORY_SPACE_GENERIC_ATTR_INDEX})
...
#define loom_x86_target_memory_space_global_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MEMORY_SPACE_GLOBAL_ATTR_INDEX})
...
#define loom_x86_target_memory_space_workgroup_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MEMORY_SPACE_WORKGROUP_ATTR_INDEX})
...
#define loom_x86_target_memory_space_constant_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MEMORY_SPACE_CONSTANT_ATTR_INDEX})
...
#define loom_x86_target_memory_space_private_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MEMORY_SPACE_PRIVATE_ATTR_INDEX})
...
#define loom_x86_target_memory_space_host_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MEMORY_SPACE_HOST_ATTR_INDEX})
...
#define loom_x86_target_memory_space_descriptor_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_MEMORY_SPACE_DESCRIPTOR_ATTR_INDEX})
...
#define loom_x86_target_abi_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_ABI_ATTR_INDEX})
...
#define loom_x86_target_export_symbol_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_EXPORT_SYMBOL_ATTR_INDEX})
...
#define loom_x86_target_linkage_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_LINKAGE_ATTR_INDEX})
...
#define loom_x86_target_contract_set_key_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_CONTRACT_SET_KEY_ATTR_INDEX})
...
#define loom_x86_target_contract_feature_bits_field() \
  ((loom_attr_field_t){LOOM_X86_TARGET_CONTRACT_FEATURE_BITS_ATTR_INDEX})
