...
static const char kObjectVadd4Text[] =
    ...
    "\n"
    "define dso_local void @vadd4_object(ptr noalias noundef readonly %v0.x, "
    "ptr noalias noundef readonly %v1.y, ptr noalias noundef writeonly %v2.z, "
    "i64 noundef %v3.base) {\n"
    "bb0.entry:\n"
    "  %v4.x.ptr = getelementptr float, ptr %v0.x, i64 %v3.base\n"
    "  %v5.y.ptr = getelementptr float, ptr %v1.y, i64 %v3.base\n"
    "  %v6.z.ptr = getelementptr float, ptr %v2.z, i64 %v3.base\n"
    "  %v7.x.v = load <4 x float>, ptr %v4.x.ptr, align 4\n"
    "  %v8.y.v = load <4 x float>, ptr %v5.y.ptr, align 4\n"
    "  %v9.z.v = fadd <4 x float> %v7.x.v, %v8.y.v\n"
    "  store <4 x float> %v9.z.v, ptr %v6.z.ptr, align 4\n"
    "  ret void\n"
    "}\n";
...
static const char kCallConstantsText[] =
    ...
    "target triple = \"x86_64-unknown-linux-gnu\"\n"
    "\n"
    "declare i32 @callee_i32(i32 %v0.value)\n"
    "\n"
    "declare void @sink_i32(i32 %v1.value)\n"
    "\n"
    "define dso_local i32 @call_i32(i32 noundef %v2.x) {\n"
    "bb0.entry:\n"
    "  %v4.y = call i32 @callee_i32(i32 42)\n"
    "  call void @sink_i32(i32 %v2.x)\n"
    "  ret i32 %v4.y\n"
    "}\n";
...
static const char kBuiltinIntrinsicsText[] =
    ...
    "\n"
    "declare void @llvm.prefetch.p0(ptr readonly nocapture, i32 immarg, i32 "
    "immarg, i32 immarg)\n"
    "\n"
    "define dso_local void @memory_ops(ptr %v16.target, ptr %v17.source) {\n"
    "bb0.entry:\n"
    "  call void @llvm.lifetime.start.p0(i64 16, ptr %v16.target)\n"
    "  call void @llvm.memset.p0.i64(ptr %v16.target, i8 0, i64 16, i1 0)\n"
    "  call void @llvm.memcpy.p0.p0.i64(ptr %v16.target, ptr %v17.source, i64 "
    "16, i1 0)\n"
    "  call void @llvm.prefetch.p0(ptr %v17.source, i32 0, i32 3, i32 1)\n"
    "  call void @llvm.lifetime.end.p0(i64 16, ptr %v16.target)\n"
    "  ret void\n"
    "}\n";
...
static const char kX86IntrinsicsText[] =
    ...
    "  %v0.ticks = call i64 @llvm.x86.rdtsc()\n"
    "  ret i64 %v0.ticks\n"
    "}\n";
...
static const char kStackAllocaText[] =
    ...
    "declare void @llvm.lifetime.end.p0(i64 immarg, ptr nocapture)\n"
    "\n"
    "define dso_local float @stack_slot(float %v4.value) {\n"
    "bb0.entry:\n"
    "  %v7.slot = alloca float, align 4\n"
    "  call void @llvm.lifetime.start.p0(i64 4, ptr %v7.slot)\n"
    "  store float %v4.value, ptr %v7.slot, align 4\n"
    "  %v8.loaded = load float, ptr %v7.slot, align 4\n"
    "  call void @llvm.lifetime.end.p0(i64 4, ptr %v7.slot)\n"
    "  ret float %v8.loaded\n"
    "}\n";
...
static const char kGlobalConstantText[] =
    ...
    "bb0.entry:\n"
    "  %v2.value = load i32, ptr @answer, align 4\n"
    "  ret i32 %v2.value\n"
    "}\n";
...
static const char kAtomicCmpxchgText[] =
    ...
    "target triple = \"x86_64-unknown-linux-gnu\"\n"
    "\n"
    "define dso_local i32 @cmpxchg_i32(ptr %v0.ptr, i32 %v1.expected, i32 "
    "%v2.replacement) {\n"
    "bb0.entry:\n"
    "  %v3.pair = cmpxchg weak ptr %v0.ptr, i32 %v1.expected, i32 "
    "%v2.replacement syncscope(\"workgroup\") acq_rel acquire, align 4\n"
    "  %v4.old = extractvalue { i32, i1 } %v3.pair, 0\n"
    "  ret i32 %v4.old\n"
    "}\n";

static const char kCfgPhiText[] =
    "define i32 @select_i32(i1 %v0.c, i32 %v1.a, i32 %v2.b) {\n"
    "bb0.entry:\n"
    "  br i1 %v0.c, label %bb1.then, label %bb2.else\n"
    "bb1.then:\n"
    "  br label %bb3.join\n"
    "bb2.else:\n"
    "  br label %bb3.join\n"
    "bb3.join:\n"
    "  %v3.x = phi i32 [ %v1.a, %bb1.then ], [ %v2.b, %bb2.else ]\n"
    "  ret i32 %v3.x\n"
    "}\n";

static const char kScalarBinopText[] =
    "define i32 @binops(i32 %v0.lhs, i32 %v1.rhs, float %v2.xf, float %v3.yf) "
    "{\n"
    "bb0.entry:\n"
    "  %v4.sum = add nuw nsw i32 %v0.lhs, %v1.rhs\n"
    "  %v5.difference = sub i32 %v4.sum, %v1.rhs\n"
    "  %v6.product = mul i32 %v5.difference, %v0.lhs\n"
    "  %v7.unsigned_quotient = udiv i32 %v6.product, %v1.rhs\n"
    "  %v8.signed_quotient = sdiv exact i32 %v6.product, %v1.rhs\n"
    "  %v9.unsigned_remainder = urem i32 %v7.unsigned_quotient, %v1.rhs\n"
    "  %v10.signed_remainder = srem i32 %v8.signed_quotient, %v1.rhs\n"
    "  %v11.bits = and i32 %v9.unsigned_remainder, %v10.signed_remainder\n"
    "  %v12.either = or i32 %v11.bits, %v0.lhs\n"
    "  %v13.toggled = xor i32 %v12.either, %v1.rhs\n"
    "  %v14.shifted = shl i32 %v13.toggled, %v1.rhs\n"
    "  %v15.logical_shifted = lshr i32 %v14.shifted, %v1.rhs\n"
    "  %v16.arithmetic_shifted = ashr i32 %v15.logical_shifted, %v1.rhs\n"
    "  %v17.float_sum = fadd fast float %v2.xf, %v3.yf\n"
    "  %v18.float_difference = fsub float %v17.float_sum, %v3.yf\n"
    "  %v19.float_product = fmul float %v18.float_difference, %v2.xf\n"
    "  %v20.float_quotient = fdiv float %v19.float_product, %v3.yf\n"
    "  %v21.float_remainder = frem float %v20.float_quotient, %v3.yf\n"
    "  %v22.float_negated = fneg nsz float %v21.float_remainder\n"
    "  ret i32 %v16.arithmetic_shifted\n"
    "}\n";

static const char kVectorElementsText[] =
    "define <4 x float> @vector_elements(<4 x float> %v0.vector, float "
    "%v1.value, i32 %v2.index) {\n"
    "bb0.entry:\n"
    "  %v3.lane = extractelement <4 x float> %v0.vector, i32 %v2.index\n"
    "  %v4.sum = fadd float %v3.lane, %v1.value\n"
    "  %v5.updated = insertelement <4 x float> %v0.vector, float %v4.sum, i32 "
    "%v2.index\n"
    "  ret <4 x float> %v5.updated\n"
    "}\n";

static const char kShuffleVectorText[] =
    "define <4 x float> @shuffle_vector(<4 x float> %v3.lhs, <4 x float> "
    "%v4.rhs) {\n"
    "bb0.entry:\n"
    "  %v5.interleaved = shufflevector <4 x float> %v3.lhs, <4 x float> "
    "%v4.rhs, <4 x i32> <i32 0, i32 4, i32 1, i32 5>\n"
    "  %v6.reversed = shufflevector <4 x float> %v3.lhs, <4 x float> poison, "
    "<4 x i32> <i32 3, i32 2, i32 1, i32 0>\n"
    "  ret <4 x float> %v5.interleaved\n"
    "}\n";

static const char kCompareSelectText[] =
    "define i32 @compare_select(i32 %v0.x, i32 %v1.lower, i32 %v2.upper, float "
    "%v3.xf, float %v4.yf) {\n"
    "bb0.entry:\n"
    "  %v5.below = icmp slt i32 %v0.x, %v1.lower\n"
    "  %v6.above = icmp sgt i32 %v0.x, %v2.upper\n"
    "  %v7.ordered = fcmp olt float %v3.xf, %v4.yf\n"
    "  %v8.at_least_lower = select i1 %v5.below, i32 %v1.lower, i32 %v0.x\n"
    "  %v9.clamped = select i1 %v6.above, i32 %v2.upper, i32 "
    "%v8.at_least_lower\n"
    "  %v10.result = select i1 %v7.ordered, i32 %v9.clamped, i32 %v0.x\n"
    "  ret i32 %v10.result\n"
    "}\n";

static const char kCastsText[] =
    "define void @casts(i64 %v0.wide, i16 %v1.narrow, float %v2.scalar, double "
    "%v3.wide_scalar, ptr %v4.pointer) {\n"
    "bb0.entry:\n"
    "  %v5.truncated = trunc i64 %v0.wide to i32\n"
    "  %v6.zero_extended = zext i16 %v1.narrow to i64\n"
    "  %v7.sign_extended = sext i16 %v1.narrow to i64\n"
    "  %v8.fp_truncated = fptrunc double %v3.wide_scalar to float\n"
    "  %v9.fp_extended = fpext float %v2.scalar to double\n"
    "  %v10.unsigned_to_fp = uitofp i16 %v1.narrow to float\n"
    "  %v11.signed_to_fp = sitofp i16 %v1.narrow to float\n"
    "  %v12.fp_to_unsigned = fptoui float %v2.scalar to i32\n"
    "  %v13.fp_to_signed = fptosi float %v2.scalar to i32\n"
    "  %v14.ptr_to_int = ptrtoint ptr %v4.pointer to i64\n"
    "  %v15.ptr_to_addr = ptrtoaddr ptr %v4.pointer to i64\n"
    "  %v16.int_to_ptr = inttoptr i64 %v0.wide to ptr\n"
    "  %v17.bits = bitcast float %v2.scalar to i32\n"
    "  %v18.global_pointer = addrspacecast ptr %v4.pointer to ptr "
    "addrspace(1)\n"
    "  ret void\n"
    "}\n";

static const char kInlineAsmText[] =
    "define i32 @inline_asm_add(i32 %v0.lhs, i32 %v1.rhs) {\n"
    "bb0.entry:\n"
    "  %v2.sum = call i32 asm sideeffect \"addl $2, $0\", \"=r,0,r\"(i32 "
    "%v0.lhs, i32 %v1.rhs)\n"
    "  ret i32 %v2.sum\n"
    "}\n";
...
static const char kAmdgpuIntrinsicsText[] =
    ...
    "\n"
    "define amdgpu_kernel void @add_dispatch(ptr addrspace(1) inreg noundef "
    "%v0.x, ptr addrspace(1) inreg noundef %v1.y, ptr addrspace(1) inreg "
    "noundef %v2.z) #0 {\n"
    "bb0.entry:\n"
    "  %v10.tid = call range(i32 0, 64) i32 @llvm.amdgcn.workitem.id.x()\n"
    "  %v11.x.rsrc = call ptr addrspace(7) "
    "@llvm.amdgcn.make.buffer.rsrc.p7.p1(ptr addrspace(1) %v0.x, i16 0, i64 "
    "64, i32 822173696)\n"
    "  %v12.y.rsrc = call ptr addrspace(7) "
    "@llvm.amdgcn.make.buffer.rsrc.p7.p1(ptr addrspace(1) %v1.y, i16 0, i64 "
    "64, i32 822173696)\n"
    "  %v13.z.rsrc = call ptr addrspace(7) "
    "@llvm.amdgcn.make.buffer.rsrc.p7.p1(ptr addrspace(1) %v2.z, i16 0, i64 "
    "64, i32 822173696)\n"
    "  %v14.x.ptr = getelementptr float, ptr addrspace(7) %v11.x.rsrc, i32 "
    "%v10.tid\n"
    "  %v15.y.ptr = getelementptr float, ptr addrspace(7) %v12.y.rsrc, i32 "
    "%v10.tid\n"
    "  %v16.z.ptr = getelementptr float, ptr addrspace(7) %v13.z.rsrc, i32 "
    "%v10.tid\n"
    "  %v17.x.value = load <1 x float>, ptr addrspace(7) %v14.x.ptr, align 4\n"
    "  %v18.y.value = load <1 x float>, ptr addrspace(7) %v15.y.ptr, align 4\n"
    "  %v19.z.value = fadd <1 x float> %v17.x.value, %v18.y.value\n"
    "  store <1 x float> %v19.z.value, ptr addrspace(7) %v16.z.ptr, align 4\n"
    "  ret void\n"
    "}\n"
    "\n"
    "declare i32 @llvm.amdgcn.workitem.id.x()\n"
    "\n"
    "declare ptr addrspace(7) @llvm.amdgcn.make.buffer.rsrc.p7.p1(ptr "
    "addrspace(1) readnone, i16, i64, i32)\n"
    "\n"
    "attributes #0 = { alwaysinline \"amdgpu-flat-work-group-size\"=\"1,1024\" "
