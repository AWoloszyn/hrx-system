...
// LLVMIR arithmetic instruction emission.

#ifndef LOOM_TARGET_EMIT_LLVMIR_FUNCTION_ARITHMETIC_H_
#define LOOM_TARGET_EMIT_LLVMIR_FUNCTION_ARITHMETIC_H_
...
#endif  // LOOM_TARGET_EMIT_LLVMIR_FUNCTION_ARITHMETIC_H_
