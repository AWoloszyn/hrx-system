...
#define LOOM_LLVMIR_SCALAR_CAST_INFOS()                                        \
  LOOM_LLVMIR_CAST_INFO(TRUNC, I32, I8, LOOM_LLVMIR_CAST_TRUNCATE),            \
      ...
      LOOM_LLVMIR_CAST_INFO(TRUNC, I64, I1, LOOM_LLVMIR_CAST_TRUNCATE),        \
      LOOM_LLVMIR_CAST_INFO(TRUNC, I64, I8, LOOM_LLVMIR_CAST_TRUNCATE),        \
      LOOM_LLVMIR_CAST_INFO(TRUNC, I64, I16, LOOM_LLVMIR_CAST_TRUNCATE),       \
      ...
      LOOM_LLVMIR_CAST_INFO(SEXT, I8, I64, LOOM_LLVMIR_CAST_SIGN_EXTEND),      \
      LOOM_LLVMIR_CAST_INFO(SEXT, I16, I64, LOOM_LLVMIR_CAST_SIGN_EXTEND),     \
      ...
      LOOM_LLVMIR_CAST_INFO(ZEXT, I1, I64, LOOM_LLVMIR_CAST_ZERO_EXTEND),      \
      LOOM_LLVMIR_CAST_INFO(ZEXT, I8, I64, LOOM_LLVMIR_CAST_ZERO_EXTEND),      \
      LOOM_LLVMIR_CAST_INFO(ZEXT, I16, I64, LOOM_LLVMIR_CAST_ZERO_EXTEND),     \
...
static const uint32_t kSelectDescriptorRefs[] = {
    LOOM_LLVMIR_SELECT_REF(I8),        LOOM_LLVMIR_SELECT_REF(I16),
