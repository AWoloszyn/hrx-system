...
// LLVMIR kernel instruction emission.

#ifndef LOOM_TARGET_EMIT_LLVMIR_FUNCTION_KERNEL_H_
#define LOOM_TARGET_EMIT_LLVMIR_FUNCTION_KERNEL_H_
...
#endif  // LOOM_TARGET_EMIT_LLVMIR_FUNCTION_KERNEL_H_
