...
//
// Consumes initialized semantic unit liveness before storage propagation.
// Scratch is released on return; the placement permission bits retain the
// result for every allocation order and strategy.
