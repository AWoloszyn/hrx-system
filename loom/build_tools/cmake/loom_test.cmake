...
# Unprofiled source checks use the same merge, test-root link, correctness, and
# benchmark tools as the Bazel loom_test rule. Profiled device tests retain
# their explicit CMake declarations and resource policy.
function(loom_test)
  if(NOT IREE_BUILD_TESTS)
    return()
  endif()
  cmake_parse_arguments(
    _RULE "" "NAME;INPUT_FORMAT;RESOURCE_GROUP" "SRCS;LIBRARIES;DATA;INPUTOPTS;ARGS;LABELS;SANITIZER_SUPPRESSIONS" ${ARGN}
  )
