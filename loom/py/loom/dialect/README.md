...
presence queries, and builders. Its footer includes `ops.inc`, generated by the
same dialect build action, for the less common named attribute helpers. Those
definitions are available under the corresponding Bazel or CMake output path.
