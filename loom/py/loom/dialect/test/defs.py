...
test_effectful_constant = Op(
    ...
    group=test_ops,
    doc=("Independently observable test op with exact result facts. This guards the canonicalizer contract that fact folding may use exact facts from an observable op without erasing the op itself."),
