...
class RegClassFlag(CEnum):
    ...
    EVEN_ALIGNED_TUPLES = "LOOM_LOW_REG_CLASS_FLAG_EVEN_ALIGNED_TUPLES"
...
class ScheduleClassFlag(CEnum):
    ...
    DISJOINT_ISSUE_USES = "LOOM_LOW_SCHEDULE_CLASS_FLAG_DISJOINT_ISSUE_USES"
...
class DescriptorFlag(CEnum):
    ...
    # Full source-order fence beyond the descriptor's memory/protocol barrier.
