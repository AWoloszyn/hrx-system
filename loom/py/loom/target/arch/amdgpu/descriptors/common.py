...
def _amdgpu_mfma_schedule_classes(
    ...
    return tuple(
        ScheduleClass(
            ...
            minimum_issue_separation_cycles=timing.latency_cycles,
            issue_uses=(
                IssueUse(
                    _RESOURCE_MFMA,
...
class AmdgpuAtomicValueKind(CEnum):
    B32 = "LOOM_AMDGPU_ATOMIC_VALUE_KIND_B32"
    ...
    *,
    ...
    return tuple(
        ScheduleClass(
            ...
            minimum_issue_separation_cycles=latency_cycles[descriptor_key],
