...
def _cdna_core_overlays(
    *,
    ...
    return (
        ...
        _s_sub_co_u32_inline_overlay("lhs"),
        _s_sub_co_u32_inline_overlay("rhs"),
        _s_subb_u32_overlay(),
        _s_subb_u32_inline_overlay("lhs"),
        _s_subb_u32_inline_overlay("rhs"),
        _s_mul_i32_overlay(),
        ...
        *_integer_bit_count_overlays(),
        ...
        _v_add_u32_rhs_tied_overlay("V_ADD_U32"),
        ...
        _v_sub_u32_lhs_tied_overlay("V_SUB_U32", "v_sub_u32"),
        ...
        *_v_mul_integer_overlays(include_literal_forms=False),
        ...
        *_global_atomic_overlays(
            ...
            cache_fields=_GFX950_VECTOR_CACHE_FIELDS,
            cache_immediate_field_names=("SC1",),
            saddr_off=None,
            address_units=1,
            descriptor_key_suffix="_saddr",
            xml_has_m0=True,
...
def _gfx11_core_overlays() -> tuple[AmdgpuDescriptorOverlay, ...]:
    return (
        ...
        *_rdna_integer_bit_count_overlays("Nothas_lit_0_Nothas_lit_1"),
        ...
        _v_add_u32_rhs_tied_overlay("V_ADD_NC_U32"),
        ...
        _v_sub_u32_lhs_tied_overlay("V_SUB_NC_U32", "v_sub_nc_u32"),
        _v_mov_b32_literal_overlay(),
        _v_mov_b32_copy_overlay(),
        _v_mov_b32_dpp16_overlay(),
        _v_mov_b32_dpp16_masked_overlay(),
        *_v_mul_integer_overlays(),
        _v_mul_u32_u24_overlay(),
        _v_mul_u32_u24_src0_inline_overlay(),
        _v_mul_u32_u24_literal_overlay(),
