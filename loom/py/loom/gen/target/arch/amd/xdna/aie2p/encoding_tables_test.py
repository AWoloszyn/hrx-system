...
def test_outputs_contain_owned_tables() -> None:
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        register_path = Path(temp_dir) / "register_tables.inl"
        ...
        register_contents = register_path.read_text(encoding="utf-8")
    ...
    assert "kMoveDescriptorOrdinals" in register_contents
