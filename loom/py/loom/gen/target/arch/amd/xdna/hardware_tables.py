    ...
    for tile in family.tiles:
        ...
        tile_lines.extend(
            [
                ...
                f"            .transfer_length_granularity = {dma.transfer_length_granularity},",
                f"            .transfer_length_offset = {dma.transfer_length_offset},",
                f"            .memory_to_stream_port_base = {dma.memory_to_stream_port_base},",
                f"            .memory_to_stream_port_stride = {dma.memory_to_stream_port_stride},",
                f"            .stream_to_memory_port_base = {dma.stream_to_memory_port_base},",
                f"            .stream_to_memory_port_stride = {dma.stream_to_memory_port_stride},",
    ...
    for profile in DEVICE_PROFILES:
        ...
        profile_lines.extend(
            [
                ...
                f"            .instruction_address_alignment = UINT32_C({profile.limits.instruction_address_alignment}),",
