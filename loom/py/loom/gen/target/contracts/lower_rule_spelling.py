...
GUARD_KIND_C_NAMES = {
    ...
    GuardKind.VALUE_EXACT_FLOAT: "LOOM_LOW_LOWER_GUARD_VALUE_EXACT_FLOAT",
    ...
    GuardKind.VALUE_FLOAT_EQUALS: "LOOM_LOW_LOWER_GUARD_VALUE_FLOAT_EQUALS",
...
ATTR_COPY_KIND_C_NAMES = {
    ...
    LowerAttrCopyKind.I64_LOG2: "LOOM_LOW_LOWER_ATTR_COPY_I64_LOG2",
    ...
    LowerAttrCopyKind.ATTRS_PACK_CONSECUTIVE: "LOOM_LOW_LOWER_ATTR_COPY_ATTRS_PACK_CONSECUTIVE",
    ...
    LowerAttrCopyKind.VALUE_FLOAT_BITS: "LOOM_LOW_LOWER_ATTR_COPY_VALUE_FLOAT_BITS",
    ...
    LowerAttrCopyKind.I64_ATTR_MINUS_LITERAL: "LOOM_LOW_LOWER_ATTR_COPY_I64_ATTR_MINUS_LITERAL",
}
...
EMIT_KIND_C_NAMES = {
    ...
    LowerEmitKind.REGISTER_SLICE: "LOOM_LOW_LOWER_EMIT_REGISTER_SLICE",
...
EMIT_FLAG_C_NAMES = {
    ...
    LOWER_EMIT_FLAG_RECORD_SOURCE_MEMORY: "LOOM_LOW_LOWER_EMIT_FLAG_RECORD_SOURCE_MEMORY",
}
